...
public class Ppal {
	...
	public static void main(String[] args) {
		...
		// ColecciÃ³n de corredores
		List<Corredor> corredores = new ArrayList<Corredor>();

		corredores.add(new Corredor(4, 1.43, "Jesse Owens"));
		corredores.add(new Corredor(8, 1.11, "Ã�ngel Naranjo"));
		corredores.add(new Corredor(3, 2.23, "Abel AntÃ³n"));
		corredores.add(new Corredor(1, 1.12, "Luis Miguel LÃ³pez"));
		...
		do {
			...
			switch (opcionUser) {
				case 1:
					// ******************
					// Ordenamos todos los corredores por nombre, sentido inverso aorden alfabÃ©tico
					System.out.println();
					System.out.println("\tCORREDORES (ordenados alfabéticamente, fÃ­jate en la Ã� con tilde)");
					// Al mÃ©todo sort de Collections se le pueden pasar dos argumentos
					// La lista a ordenar, en este caso corredores
					// De tipo List es hija de Colletions y
					// cÃ³mo ordenar, en este caso, un objeto de la clase
					// que implemente el mÃ©todo que vamos a usar para ordenar
				...
				case 3:
					// ******************
					// imprimimos los 3 primeros con marca mÃ¡s baja
					System.out.println();

package com.salesianostriana.dam.ethfechas.servicios.base;
...
/**
 * Explicado en las clases de Luismi. de todas formas, repetimos por si sirve de repaso 
 * y no tener que ir al video de la clase en cuestión:
 * 
 ...
 * Este tipo de datos "delimitado". ¿Qué significa eso? 
 * 
 ...
 * de ahí el que se le llame delimitado, pues
 * estamos delimitando el tipo de objetos que se pueden usar a aquellos que cumplan esto.
 * 
...
public abstract class BaseService<T, ID, R extends JpaRepository<T, ID>> {
	...
	public T findById(ID id) {
		//Devolvemos la entidad si la encuentra u otro si no lo encuentra, en este caso, 
